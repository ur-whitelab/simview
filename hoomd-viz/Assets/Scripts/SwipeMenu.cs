...
//      Debug.Log("num menuItems: " + menuItems.Length);
      float radiansPerItem = 2.0f * Mathf.PI / numItems;
      ...
      const float SELECT_RADIUS = 0.04f;
            ...
            bool touching = gvrController.GetButton(GvrControllerButton.TouchPadTouch);
      ...
      if (gvrController.GetButton(GvrControllerButton.TouchPadButton))
            {
                touchOrigin = touchPos;
            }
